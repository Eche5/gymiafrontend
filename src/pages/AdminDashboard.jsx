...
function AdminDashboard() {
  ...
  const currentpage = location.pathname === `/admin/${id}/trainers`;

  return (
    <div className=" p-1 flex justify-center">
      <div className="w-[15%] h-[99vh] mx-2   bg-gray-700 rounded-lg pt-8 ">
        <div className="flex flex-col  pb-32">
          <NavLink
            to={`/admin/${id}`}
            className={({ isActive }) =>
              isActive
                ? "bg-white text-black text-xl font-bold  flex justify-center items-center p-4 gap-2 m-2 rounded-lg"
                : " text-xl text-red text-center text-white flex justify-center items-center gap-2 m-2 p-4"
            }
            end
          >
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              fill={currentpage ? "#FFFFFF" : "#FFFFFF"}
            ...
            >
              ...
              />
              <path
                d="M22 16H16V22H22V16Z"
                stroke="#141B34"
                strokeWidth="1.5"
                strokeLinejoin="round"
              />
              <path
                d="M12 12H2V22H12V12Z"
                stroke="#141B34"
                strokeWidth="1.5"
                strokeLinejoin="round"
              />
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              isActive
                ? "bg-white text-black text-xl font-bold  flex justify-center items-center p-4 gap-2 m-2 rounded-lg"
                : "text-xl text-white  font-bold  flex justify-center items-center p-4 gap-2 m-2"
            }
            end
          >
            <svg
        ...
        <div className="flex flex-col ">
          ...
          <NavLink className=" flex items-center gap-2 text-white justify-center">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
            ...
            <p className=" text-center items-center text-white text-xl">
              Logout
            </p>
          </NavLink>
        </div>
